...
<table  bgcolor="#C0C0C0" id='myTable'>
        ...
        <tbody id="data"  data-link="row" class="rowlink">
          ...
          if ($mails) {
              ...
              <td  onClick= "">
              	<a href=<?php echo "Sent/show_view"; echo "/"; echo $mail->message_id;?>>
...
<script>
 ...
 <script>
 	...
 	function send_data(a, b,c, d,e) {
        ...
        dataType:"JSON",
        url:"http://localhost/falconemail/index.php/Sent/show_mail_details",
        ...
        success: function(data){
            ...
            location.href = "http://localhost/falconemail/index.php/Sent/show_view";
        }
             return true;
            }
      });
